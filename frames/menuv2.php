                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-8 col-sm-12 col-xs-12 center_responsive">
                        <div class="header-area hidden-menu-bar stick" id="sticker">
                            ...
                            <div class="mainmenu">
                                ...
                                <ul class="float_left">
                                    <li class="has-mega gc_main_navigation"><a href="#" class="gc_main_navigation"> Inicio&nbsp;<i class="fa fa-angle-down"></i></a>
                                        <!-- mega menu start -->
                                        <ul>
                                    ...
                                    <li class="has-mega gc_main_navigation"><a href="#" class="gc_main_navigation"> Pages&nbsp;<i class="fa fa-angle-down"></i></a>
                                        ...
                                        <ul>
                                            ...
                                            <li class="parent"><a href="login.html">Ingresar</a></li>
                                            <li class="parent"><a href="register.html">Register</a></li>
                                            <li class="parent"><a href="pricing.html">Pricing</a></li>
                                            <li class="parent"><a href="message.html">message</a></li>
                                            <li class="parent"><a href="client_reivew.html">client reivew</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="gc_main_navigation parent"><a href="contact.html" class="gc_main_navigation">Contactar</a></li>
                                </ul>
                            </div>
                            <!-- mainmenu end -->
                                                    ...
                                                    <ul class="cd-dropdown-content">
                                                        ...
                                                        <li class="has-children">
                                                            ...
                                                            <ul class="cd-secondary-dropdown is-hidden">
                                                                ...
                                                                <li><a href="client_reivew.html">client reivew</a></li>
                                                                <!-- .has-children -->
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12 hidden-sm hidden-xs">
                        <div class="jp_navi_right_btn_wrapper">
                            <ul>
                                <li><a href="register.php"><i class="fa fa-user"></i>&nbsp; Registrate</a></li>
                                <li><a href="login.php"><i class="fa fa-sign-in"></i>&nbsp; Ingresar</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
