                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="jp_hiring_slider_main_wrapper">
                            <div class="jp_hiring_heading_wrapper">
                                <h2>Especialistas Reconocidos</h2>
                            </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="cc_featured_product_main_wrapper">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li role="presentation" class="active"><a href="#best" aria-controls="best" role="tab" data-toggle="tab">Presencial</a></li>
                                <!-- <li role="presentation"><a href="#hot" aria-controls="hot" role="tab" data-toggle="tab">Remoto</a></li>
                        ...
                        <div class="tab-content" id="postcome">



                            <div role="tabpanel" class="tab-pane fade in active">
                                <div class="ss_featured_products">
                                    <div class="owl-carousel owl-theme" id="resultable">
                                ...
                                <div class="video_nav_img_wrapper">
                                    <div class="video_nav_img">
                                        <ul>
                                            ...
                                            <!-- <li><a class="button secondary url owl_nav" href="#data0">1</a></li>
                                            <li><a class="button secondary url owl_nav" href="#data1">2</a></li>
                                            <li><a class="button secondary url owl_nav active" href="#data2">3</a></li> -->
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                                ...
                                                                <div class="jp_job_post_right_cont">
                                                                    <h4>Desarrollador HTML (1 - 2 Yrs Exp.)</h4>
                        ...
                        <div class="jp_register_section_main_wrapper">
                            <div class="jp_regis_left_side_box_wrapper">
                                <div class="jp_regis_left_side_box">
                                    ...
                                    <h4>¿Eres cliente?</h4>
                                    <p>Registrate aqui y contacta especialistas...</p>
                                    <ul>
                                        <li><a href="#"><i class="fa fa-plus-circle"></i> &nbsp;Registrate.</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="jp_regis_right_side_box_wrapper">
                                ...
                                <div class="jp_regis_right_side_box">
                                    ...
                                    <h4>¿Eres especialista?</h4>
                                    <p>Registrate aqui y comienza a contactar a clientes...</p>
                                    <ul>
                                        <li><a href="#"><i class="fa fa-plus-circle"></i> &nbsp;Registrate Aqui.</a></li>
                                    </ul>
                                </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="jp_add_resume_wrapper">
                                ...
                                <div class="jp_add_resume_cont">
                                    ...
                                    <h4>Los mejores Especialistas de Servicios estan aqui!</h4>
                                    <ul>
                                        <li><a href="#"><i class="fa fa-plus-circle"></i> &nbsp;¿Quienes somos?</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="jp_rightside_job_categories_wrapper">
                                ...
                                <div class="jp_rightside_job_categories_content">
                                    <ul>
                                        <li><i class="fa fa-caret-right"></i> <a href="#"><span>Más Categorias</span></a></li>

                                        <li>
                                            <select id="idcatservicio">
                                        ...
                                        <li><i class="fa fa-caret-right"></i> <a href="#"><span>Mas Ubicaciones</span></a></li>
                                        ...
                                        <li>
                                            <div class="jp_adp_form_wrapper">
                                                <select id="iddistrito">
                                                    <option value="">Escoge Ubicación</option>

                                                </select>
                                            </div>

                                        </li>
                                        <li><i class="fa fa-caret-right"></i> <a href="#"><span>Empresa / Especialista</span></a></li>
                                        <li><input id='txtnameespe' placeholder="Indicar Nombre"></input></li>
                                        
                                        
                                        <div class="jp_spotlight_slider_btn">
                                            
                                                    <ul>
                                                        <li><button type="button" onclick='searchfront()'><i class="fa fa-plus-circle"></i> Buscar más</a></li>
                                                    </ul>
                                                </div>
                                    </ul>
                                </div>
...
<script>
    $(document).ready(function() {
        ...
        letterclaves();
        menuv2();
        // Solo para el cambio de combo servicios
        servicechange();
