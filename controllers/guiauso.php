...
echo "<p class='card-text'>Hola, seré tu guia en la plataforma <strong>IBrokerGo!.</strong> Cualquier otra duda puedes escribirnos a <strong>contacto@ibrokergo.com</strong></p>";
echo "<p class='card-text'><small class='text-muted'>Gracias por usar IBrokerGo!</small></p>";
