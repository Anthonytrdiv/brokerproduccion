                ...
                if ($desincryptar->desincryptarpass($password, $passdb) == "1") {
                    ...
                    foreach ($selectuser->listaruser($email2) as $foreachresultselect) {
                        ...
                        if ($foreachresultselect['statususer'] == 1) {
                            ...
                            echo "El usuario se encuentra bloqueado , envia un correo a contacto@ibrokergo.com para saber el motivo";
                        } else if ($foreachresultselect['statususer'] == 3) {
                            echo "Intenta con otro email diferente ,esta cuenta esta eliminada o envia un correo a contacto@ibrokergo.com";
